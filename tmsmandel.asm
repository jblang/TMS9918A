...
iteration_max   defb    14                      ; How many iterations
x               defw    0                       ; x-coordinate
x_start         defw    scale * -2              ; Minimum x-coordinate
x_end           defw    scale - 1               ; Maximum x-coordinate
x_step          defw    3                       ; x-coordinate step-width
y               defw    -9 * (scale / 8)        ; Minimum y-coordinate
y_end           defw    9 * (scale / 8) - 1     ; Maximum y-coordinate
y_step          defw    3                       ; y-coordinate step-width
z_0             defw    0
z_1             defw    0
scratch_0       defw    0
